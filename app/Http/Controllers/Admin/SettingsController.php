...
class SettingsController extends Controller
{
    ...
    public function updateInformation(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.settings')->with('success', 'Informasi akun berhasil diubah.');
    }
    ...
    public function updatePassword(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.settings')->with('error', 'Password tidak ada perubahan.');
    }
    ...
    public function updateAvatar(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.settings')->with('success', 'Avatar berhasil diubah.');
    }
}
