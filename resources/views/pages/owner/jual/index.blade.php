            ...
            <div class="dashboard-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ route('jual.create') }}" class="btn btn-primary mb-3">
                                    + Add New
                                </a>
                                <a href="{{ route('owner.jual.print') }}" class="btn btn-primary mb-3" data-toggle="modal"
...
@push('outside')
    ...
    <div class="modal fade" id="printModal" tabindex="-1" aria-labelledby="printModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form action="{{ route('owner.jual.print') }}" method="GET" class="modal-content">
