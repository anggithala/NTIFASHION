                    ...
                    <div class="col-12">
                        <div id="test_update">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <form method="POST" action="{{ route('owner.update.info') }}" id="update_info">
                                            @csrf
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <form method="POST" action="{{ route('owner.update.password') }}"
                                                id="update_password">
                                                @csrf
                                                <div class="mt-5 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <form method="POST" action="{{ route('owner.update.avatar') }}"
